#!/usr/bin/env python
"""Bilayer graphene density scan using the direct-minimization solver.

Runs the jax_hf direct-minimization solver at a list of carrier densities for
...
Usage:
    python examples/multilayer_graphene_density_scan.py
    python examples/multilayer_graphene_density_scan.py --branches SVP
    python examples/multilayer_graphene_density_scan.py --density-points -0.25 0.0 0.25
"""
...
DEFAULT_OUTPUT = REPO_ROOT / "examples" / "outputs" / "direct_minimization_density_scan.csv"
...
def main() -> int:
    ...
    if not args.no_figure:
        common.write_figure(
            ...
            title="Bilayer graphene PM/SVP (direct minimization)",
        )
